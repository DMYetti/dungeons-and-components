...
export default function Chapter1() {
  return (
    <Page footnote="Chapter 1 — [Chapter 1 Name]">
      ...
      <p>Intro to the section. Set the scene for the characters. You may choose to open this section with a read-aloud block. Keep the read-aloud text short and descriptive.</p>
      ...
      <Note>
        <p>Chapter 1 should have between 800 – 1000 words. Use read-aloud text sparingly; it’s helpful for DMs to set the scene but can also detract from important information they need.</p>
      </Note>

      <Heading1>Map</Heading1>
      <p>This chapter is a good place to put your map key! You should use your map as the basis for your whole adventure, so the first chapter may be where you describe the locations on it.</p>
