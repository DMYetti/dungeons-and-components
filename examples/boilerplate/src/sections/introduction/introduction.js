  ...
  return (
    <>
      <Page footnote="Introduction">
        ...
        <p>What is the story about? (Think of this like the summary on the back of a book.) <em>100-200 words.</em></p>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>

        <Heading1>Using This Adventure</Heading1>
        <p>This adventure can be played with the Dungeons and Dragons 5e Basic Ruleset provided from the wizard of the coast website. The Dungeon Master’s Guide (DMG), Player’s Handbook (PHB), and Monster Manual (MM) are recommended but not a requirement.</p>

        <Description>
          <p>When you see a dialogue box like this; it’s meant to be read out loud or paraphrased for the Player Characters to set up some immersion.</p>
        </Description>
      ...
      <Page footnote="About This Adventure">
        ...
        <p>What information do DMs need to know to run the module? <em>100-300 words.</em></p>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>

        <Heading1>Adventure Hooks</Heading1>
        <p>How can the characters participate or get involved in the story? <em>100-200 words.</em></p>
